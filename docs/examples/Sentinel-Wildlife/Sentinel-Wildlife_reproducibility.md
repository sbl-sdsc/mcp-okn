...
- **Date:** 2026-07-29
- **Model:** claude-opus-5
- **Skills:** okn-bioanalysis · okn-report-style
...
- `fiokg` facilities: `kwg:sfWithin` a `spatialkg` `AdministrativeRegion_2` node `administrativeRegion.USA.12xxx`; **118,663 facilities over 67 counties**.
