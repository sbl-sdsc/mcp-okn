...
cc = c[["rank", "county_name", "fips5", "conf_tier", "priority", "sentinel_species",
        ...
        "records_bird", "records_amphibian", "frs_facilities", "spoke_chemicals_found",
...
cc.columns = ["rank", "county", "FIPS", "tier", "priority score", "sentinel-capable species",
              ...
              "EPA FRS facilities", "spoke-okn chemicals in county", "adult asthma %",
...
for r in c.itertuples():
    rows.append({"rank": int(r.rank), "county": r.county_name, "FIPS": r.fips5,
                 ...
                 "facilities": int(r.frs_facilities), "asthma_pct": r.adult_asthma_pct,
                 "samples": 0,
...
table = candidate_table(
    ...
    columns=[("rank", "#"), ("county", "county"), ("FIPS", "FIPS"), ("tier", "tier"),
             ...
             ("species", "species observed"), ("facilities", "EPA FRS facilities"),
    ...
    numeric_keys=["rank", "score", "sentinel_sp", "host_sp", "species", "facilities",
                  "asthma_pct", "samples"],
