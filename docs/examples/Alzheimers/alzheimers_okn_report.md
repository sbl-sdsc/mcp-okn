...
| 7 | Contradictory evidence for HRT/oestrogen, NSAIDs, statins, vitamin E, ginkgo, metformin | **CONSISTENT WITH THE LITERATURE'S OWN STATE** — These are precisely the interventions with conflicting trial and observational results; `biohealth`'s asserted-plus-negated structure reproduces that disagreement rather than resolving it. |
