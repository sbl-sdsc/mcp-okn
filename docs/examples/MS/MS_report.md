...
According to **PubMed** (via the PubMed MCP connector) and **Paperclip**, the headline claims from this analysis were checked against the primary literature; every PMID below was resolved and its metadata verified, and full text was consulted where an open-access version exists. Claims that could not be corroborated are marked as such. The full per-claim document with citations is [MS_literature_comparison.md](MS_literature_comparison.md).
...
| 8 | NfL and OCB are the clinically dominant biomarkers, and are absent here | **SUPPORTED** — a real KG gap. OCB is in the McDonald 2017 criteria; serum NfL Z-scores are prognostically validated. Urate is a correlate, not causal (MR null). Quinolinic acid: **NOVEL**, no source found [23–27] |
...
Of the central papers, only the EBV mechanism study (Claim 6, ref 16) is available as open-access full text and was verified against it; the paywalled latitude meta-analyses (Claim 7), the EBV cohort study (Claim 6) and the BTK trial reports (Claim 9) were checked against their abstracts and metadata, not full text.
...
15. Bjornevik K, et al. Longitudinal analysis reveals high prevalence of Epstein-Barr virus associated with multiple sclerosis. *Science*. 2022. PMID:35025605 · [doi:10.1126/science.abj8222](https://doi.org/10.1126/science.abj8222)
...
19. Simpson S Jr, et al. Latitude is significantly associated with the prevalence of multiple sclerosis: a meta-analysis. *J Neurol Neurosurg Psychiatry*. 2011. PMID:21478203 · [doi:10.1136/jnnp.2011.240432](https://doi.org/10.1136/jnnp.2011.240432)
20. Simpson S Jr, et al. Latitude continues to be significantly associated with the prevalence of multiple sclerosis: an updated meta-analysis. *J Neurol Neurosurg Psychiatry*. 2019. PMID:31217172 · [doi:10.1136/jnnp-2018-320189](https://doi.org/10.1136/jnnp-2018-320189)
...
28. Fox RJ, et al. Tolebrutinib in Nonrelapsing Secondary Progressive Multiple Sclerosis. *N Engl J Med*. 2025. PMID:40202696 · [doi:10.1056/NEJMoa2415988](https://doi.org/10.1056/NEJMoa2415988)
29. Oh J, et al. Tolebrutinib versus Teriflunomide in Relapsing Multiple Sclerosis. *N Engl J Med*. 2025. PMID:40202623 · [doi:10.1056/NEJMoa2415985](https://doi.org/10.1056/NEJMoa2415985)
