...
| **Multiple sclerosis** — 14 KGs, 2,397 genes (52 Tier A) | [HTML](https://sbl-sdsc.github.io/mcp-okn/docs/examples/MS/MS_report.html) | [md](docs/examples/MS/MS_literature_comparison.md) | [xlsx](docs/examples/MS/MS_results.xlsx) | [md](docs/examples/MS/MS_reproducibility.md) | [files](docs/examples/MS/) |
