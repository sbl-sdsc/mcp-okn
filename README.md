...
|---|---|---|---|---|
| **Type 2 diabetes** — 16 KGs, 2,117 genes (381 multi-source) | [HTML](https://sbl-sdsc.github.io/mcp-okn/docs/examples/Diabetes3/T2D_OKN_report.html) | [Markdown](docs/examples/Diabetes3/T2D_OKN_report.md) | [Reproducibility](docs/examples/Diabetes3/T2D_OKN_reproducibility.md) | [Excel](docs/examples/Diabetes3/T2D_OKN_results.xlsx) |
